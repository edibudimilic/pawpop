...
const nameBank = {
  sweet: [
    ...
    ['Daisy', 'Fresh-faced, cheerful, and always ready for a sunny stroll.'],
    ['Rosie', 'A rosy little sweetheart with cuddles to spare.'],
    ['Coco', 'Smooth, cozy, and happiest tucked right beside you.'],
    ['Lulu', 'Light, lovely, and full of tiny happy dances.'],
    ['Teddy', 'A living teddy bear with champion-level snuggle skills.'],
    ['Pumpkin', 'Round, warm, and perfect for crisp-evening cuddles.'],
    ['Olive', 'A gentle little charmer with a quietly sunny spirit.'],
    ['Millie', 'Soft around the edges and sweet through the middle.'],
    ['Gingersnap', 'A little bit spicy and a whole lot lovable.'],
    ['Cupcake', 'Frosted with sweetness and topped with tiny paws.'],
    ['Buttercup', 'A golden bloom who brightens every room.'],
    ['Cherry', 'Bright, joyful, and always the treat on top.'],
    ['Fudge', 'Rich, squishy, and dangerously easy to adore.'],
    ['Sugarplum', 'A dreamy little darling sprinkled with storybook magic.'],
    ['Twinkle', 'Small enough to cuddle, bright enough to guide you home.'],
    ['Blossom', 'A gentle soul who makes love grow everywhere.'],
    ['Cinnamon', 'Warm, comforting, and just spicy enough to be fun.'],
    ['Marzipan', 'Fancy-sweet, delightfully soft, and made for special occasions.'],
    ['Truffle', 'A rare little treasure worth finding under every blanket.'],
    ['Snuggles', 'The name says it all: clear your lap immediately.']
  ],
  silly: [
    ...
    ['Gizmo', 'A mysterious little gadget powered entirely by snacks.'],
    ['Bongo', 'Two beats, four paws, and no indoor voice.'],
    ['Zoodles', 'All tangled up in joy and running through the kitchen.'],
    ['Sprocket', 'A tiny moving part in a very chaotic machine.'],
    ['Goober', 'Lovably clueless and somehow sticky again.'],
    ['Fizzgig', 'Half fizz, half fluff, and one hundred percent commotion.'],
    ['Doodle', 'A happy little scribble that wandered off the page.'],
    ['Quirk', 'Proudly odd, endlessly entertaining, and impossible to copy.'],
    ['Chonk', 'Built like a loaf and carried like royalty.'],
    ['Snorfle', 'A noise, a lifestyle, and now an excellent name.'],
    ['Wigglebutt', 'The front half arrives shortly after the back half.'],
    ['Pogo', 'Why walk anywhere when bouncing is an option?'],
    ['Nacho', 'Cheesy, crunchy, and definitely trying to steal your dinner.'],
    ['Dumpling', 'A plump little parcel filled with mischief.'],
    ['Bonkers', 'No thoughts, just speed and excellent vibes.'],
    ['Squeegee', 'An odd little word for an odd little roommate.'],
    ['Meatball', 'Round, saucy, and always under the table.'],
    ['Whoops', 'The perfect thing to shout whenever they enter a room.'],
    ['Goblin', 'A tiny household creature who hoards socks and crumbs.'],
    ['Pants', 'Nonsense on paper, pure comedy at the dog park.']
  ],
  fancy: [
    ...
    ['Theodore', 'A timeless gentleman with excellent fireside manners.'],
    ['Penelope', 'Graceful, clever, and never caught without composure.'],
    ['Archibald', 'Distinguished whiskers deserve a name with this much ceremony.'],
    ['Beatrice', 'A literary little lady with impeccable taste in cushions.'],
    ['Reginald', 'Proper at dinner, spectacularly silly after dessert.'],
    ['Genevieve', 'A sweeping name for a pet who glides into every room.'],
    ['Sebastian', 'Polished, charming, and born for a velvet collar.'],
    ['Arabella', 'Romantic, radiant, and just dramatic enough.'],
    ['Leopold', 'A stately name with a brave little heartbeat.'],
    ['Vivienne', 'Parisian poise with an occasional case of the zoomies.'],
    ['Bartholomew', 'Long, grand, and wonderfully excessive for someone so small.'],
    ['Ophelia', 'Dreamy-eyed, poetic, and happiest near a sunny window.'],
    ['Augustus', 'Imperial confidence with a weakness for belly rubs.'],
    ['Celeste', 'A heavenly name for the star of the household.'],
    ['Winston', 'Steady, dignified, and deeply serious about supper.'],
    ['Cordelia', 'Classic beauty with a clever spark behind the eyes.'],
    ['Ambrose', 'Old-world charm wrapped in a very modern cuddle bug.'],
    ['Florence', 'Elegant as a garden and twice as lovely.'],
    ['Maximilian', 'Maximum grandeur for a minimum-sized monarch.'],
    ['Esmeralda', 'Jewel-toned glamour with a hint of delightful mystery.']
  ],
  tiny: [
    ...
    ['Bitty', 'Just a bit of pet with a whole lot of heart.'],
    ['Nib', 'A tiny mark, a tiny munch, a perfect tiny name.'],
    ['Poco', 'A little name with a warm and musical bounce.'],
    ['Itty', 'So small the name nearly fits in a whisper.'],
    ['Speck', 'One precious dot in the great big universe.'],
    ['Teeny', 'Practically pocket-sized and proud of it.'],
    ['Nano', 'Microscopic name, astronomical personality.'],
    ['Dewdrop', 'Fresh, delicate, and sparkling in the morning light.'],
    ['Button', 'Cute as one, round as one, always coming loose.'],
    ['Crumb', 'Small, sweet, and somehow always on the sofa.'],
    ['Atom', 'The smallest possible unit of unstoppable energy.'],
    ['Fleck', 'A little dash of color with places to be.'],
    ['Wisp', 'Soft, airy, and gone the moment you look away.'],
    ['Minnow', 'A tiny swimmer in a very big bowl of life.'],
    ['Acorn', 'A pocket-sized beginning with mighty potential.'],
    ['Beep', 'Short, bright, and impossible not to repeat.'],
    ['Chip', 'A tiny piece that makes the whole family complete.'],
    ['Smidge', 'Just a smidge of fluff and an abundance of charm.'],
    ['Dinky', 'Delightfully little and completely unbothered by it.'],
    ['Pixel', 'One tiny square of pure high-resolution joy.']
  ],
  naughty: [
    ...
    ['Purrvert', 'Stares from the corner, watches you undress, then demands a lap dance.'],
    ['Pawrn Star', 'Always on camera, never wearing clothes, and shameless about the close-ups.'],
    ['Humpfrey Bogart', 'Of all the cushions in all the rooms, they had to climb onto yours.'],
    ['Lick Jagger', 'That tongue has moves, the hips have swagger, and satisfaction is guaranteed.'],
    ['Bark After Dark', 'Quiet all day, loud all night, and definitely disturbing the neighbors.'],
    ['Fifty Shades of Spay', 'Tied to a leash, dressed in leather, and very into obedience training.'],
    ['Mutt Plug', 'Small, rubbery, and somehow wedged exactly where it should not be.'],
    ['Paw McCartney', 'Wants to hold your hand, then hump your leg during the encore.'],
    ['Fluffy Bottoms', 'A luxurious rear end with absolutely scandalous intentions.'],
    ['Seymour Butts', 'Always looking behind them and inviting everyone else to do the same.'],
    ['Kitty Bang Bang', 'Cute face, loaded attitude, and ready to go off without warning.'],
    ['Barky Stinson', 'Suit up, sniff around, and make every night legendary.'],
    ['Chew Hefner', 'Silk robe, plush bed, and far too many bunnies in the lounge.'],
    ['Nip Tease', 'Shows a little fluff, pulls away, then leaves you begging for more.'],
    ['Poundcake', 'Thick, sweet, and taking the command far too literally.'],
    ['Hardcore Corgi', 'Low to the ground, high on stamina, and banned before the watershed.'],
    ['Freak on a Leash', 'Perfectly respectable until the collar clicks into place.'],
    ['Booty Sniffer', 'Introductions begin at the rear and manners never enter the conversation.'],
    ['Sir Mounts-a-Lot', 'No cushion, shin, or innocent stuffed toy escapes the royal attention.'],
    ['Dirty Sanchez', 'That mustache is suspicious, the grin is worse, and bath time is overdue.']
  ]
};
